...
JOB_DIR=/expscratch/${USER}/nmt/fairseq/jobs/scaling_nmt_distill/${JOB_NAME}_FROM_SCRATCH_${DIVERGENCE}_${T}_${TOPK}_${WEIGHT}_${MAX_UPDATE}_${LR}_${LS}_${DROPOUT}_${TEACHERS}
JOB_DIR="${JOB_DIR// /_}"
